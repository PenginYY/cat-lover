            ...
            <div className='container  mt-5 mx-auto'>
                ...
                <div className='flex'>
                    <div className='container p-5 mx-5 my-5'>
                        ...
                        <ul>
                            <li><h3><strong>Random Cat Pictures:</strong> Users can view a variety of random cat images.</h3></li>
                            <li><h3><strong>Image Search:</strong> Users can find images that match their personal preferences.</h3></li>
                            <li><h3><strong>Custom Cat Memes:</strong> Users can create memes by adding text to the cat images. The application provides options to choose the font color and size, allowing users to craft memes that reflect their creativity and sense of humor.</h3></li>
                        </ul>
